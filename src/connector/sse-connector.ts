 ...
 *
 * Includes: keepalive monitoring, authentication, message buffering.
 */
...
export class SSEReverseClientTransport implements Transport {
  ...
  // Message buffering while connecting
  ...
  async send(message: JSONRPCMessage, _options?: TransportSendOptions): Promise<void> {
    ...
    // If currently connecting, queue the message
    if (this._connecting) {
   ...
   * Fires onclose — the external reconnection manager (ReverseMCPClient)
   * will decide whether to reconnect.
   */
